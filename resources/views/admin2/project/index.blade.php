...
<!-------------------引入页面------------------->
    ...
    <aside class="aside0" id="hiddenDiv3" style="display: block;">
        ...
        <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="#outlet2" data-toggle="tab">服务项目列表</a></li>
            <li><a href="#outlet" data-toggle="tab">服务项目添加</a></li>
        </ul>
        <!--内容部分-->
        <div id="myTabContent" class="tab-content">
                            ...
                            <li>
                                <ul class="informationList">
                                    ...
                                    <li>
                                        ...
                                        <input class="goodsInput" id="goodsInput1" name="hj_name" type="text" placeholder="请输入服务项目名称">
                                    </li>
                                    <li>
                                        <span class="tigDiv"></span>
                                        <p class="goodsTextTitle">服务项目价格：</p>
                                        <input class="goodsInput" id="goodsInput1" name="hj_price" type="text" placeholder="请输入服务项目价格">
                                    </li>
                                    <li>
                                        <span class="tigDiv"></span>
                                        <p class="goodsTextTitle">项目获得积分：</p>
                                        <input class="goodsInput" id="goodsInput1" name="hj_integral" type="text" placeholder="请输入要获得多少积分">
                                    </li>
                                    <li>
                                        <span class="tigDiv"></span>
                                        <p class="goodsTextTitle">积分抵扣上限：</p>
                                        <input class="goodsInput" id="goodsInput1" name="hj_int_top" type="text" placeholder="请输入抵扣上限">
                                        <span>元</span>
                                    </li>
                                </ul>
                            </li>
            ...
            <!--商品列表-->
            <div class="tab-pane fade active in" id="outlet2">
                <div class="allShow2">
