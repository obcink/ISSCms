...
<!-------------------引入页面------------------->
    ...
    <aside class="aside0" id="hiddenDiv25" style="display: block;">
        ...
        <ul id="myTab3" class="nav nav-tabs">
            ...
            <li><a href="#current1" data-toggle="tab">订单流水管理</a></li>
        </ul>
        <!--内容部分-->
        <div id="myTabContent" class="tab-content">
                ...
                <div class="allShow">
                    <table class="showTable">
                        ...
                        <tr>
                            ...
                            <!--支付状态-->
                            <td>
                                <p>@if($v['hj_status'] == 'success') 已支付 @elseif($v['hj_status'] == 'fail') 支付失败 @else 未支付 @endif</p>
                            </td>
                            <!--交易方式-->
                            <td>
            ...
            <!--订单流水管理-->
            <div class="tab-pane fade" id="current1">
                <div class="allShow">
                    <table class="showTable">
                        <tbody><tr>
                            <th>订单编号</th>
                        ...
                        <tr>
                            ...
                            <!--订单日期-->
                            <td>
                                <p>{{ date('Y-m-d', $v['hj_time']) }}</p>
                            </td>
                        </tr>
                        @endforeach
                        </tbody></table>
                </div>
                <input style="margin-top:20px;" type="button" name="" id="" value="导出Excel表格">
            </div>
        </div>
    </aside>
</div>
