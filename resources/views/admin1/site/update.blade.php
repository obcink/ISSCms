...
@section('content')
    ...
    <section id="hiddenDiv26">
        ...
        <ul class="nav nav-tabs">
            <li><a href="{{ url('admin/site/index') }}">返回上一页</a></li>
            <li class="active"><a href="" data-toggle="tab">修改用户</a></li>
        </ul>
        <!--内容部分-->
        <div class="" id="pllouser">
            <div class="allShow2">
                <form action="{{ url('admin/site/update/'.$data['id']) }}" method="post">
                        ...
                        <li>
                            <ul class="informationList">
                                ...
                                <li style="height:50px;">
                                    ...
                                    <input class="goodsInput" id="lour1" name="hj_username" value="{{ $data['hj_username'] }}" type="text" placeholder="">
                                </li>
                                <!--手机号-->
                                <li style="height:50px;">
                                    <span class="tigDiv"></span>
                                    <p class="goodsTextTitle ddqq">手机号：</p>
                                    <input class="goodsInput" id="lour2" name="hj_phone" value="{{ $data['hj_phone'] }}" type="text" placeholder="">
                                </li>
                                <!--车牌号-->
                                <li style="height:50px;">
                                    <span class="tigDiv"></span>
                                    <p class="goodsTextTitle ddqq">车牌号：</p>
                                    <input class="goodsInput" id="lour3" name="hj_carnum" value="{{ $data['hj_carnum'] }}" type="text" placeholder="多个车牌号可用逗号隔开">
                                </li>
                            </ul>
                        </li>
                    </ul>
