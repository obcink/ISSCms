...
@section('content')
    ...
    <section id="hiddenDiv26">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active"><a href=""  data-toggle="tab">修改分类</a></li>
        </ul>
        <!--内容部分-->
                    ...
                    <ul class="information">
                        ...
                        <li>
                            <ul class="informationList">
                                ...
                                <li>
                                    <span class="tigDiv"></span>
                                    <p class="goodsTextTitle">封面图：<span class="tigText">上传1张图片，建议大小：200KB。</span></p>
                                ...
                                <!--广告图-->
                                <li>
                                    <p class="goodsTextTitle">广告图：</p><span class="tigText">最多添加五张，建议大小750*400像素。</span><p></p>
                            ...
                            <div class="attribute">
                                <ul class="attributeList" id="attributeList">
                                    <li>
                                        ...
                                        <input type="text" id="goodsInput3" name="hj_integral" class="attributeInput attributeInput1" value="{{ $data['hj_integral'] }}" placeholder="0">
                                        <p class="attributeIcon">个</p>
                                    </li>
                                    <li>
                                        <span class="tigDiv"></span>
                                        <p class="attributeName">最多抵扣：</p>
                                        <input type="text" id="goodsInput4" name="hj_int_top" class="attributeInput attributeInput1" value="{{ $data['hj_int_top'] }}" placeholder="0">
                                        <p class="attributeIcon">元</p>
                                    </li>
                                    {{--<li>--}}
                                    {{--<span class="tigDiv"></span>--}}
                        ...
                        <li>
                            ...
                            <input type="text" name="hj_group" value="{{ $data['hj_group'] }}"> <span class="tigText">注：值为-1不在兑换商城显示</span>
