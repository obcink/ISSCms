...
<!-------------------引入页面------------------->
    ...
    <aside class="aside0" id="hiddenDiv10" style="display: block;">
        <!--横向导航栏-->
        <ul style="margin-bottom: 30px;" id="myTab3" class="nav nav-tabs">
            <li class="active"><a href="#record0" data-toggle="tab">洗车订单</a></li>
            <form style="margin-left: 200px;" action="{{ url('admin/order/day') }}" method="get">
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fadein active" id="record0">
                <div class="allShow">
                    ...
                    <div>{{ $carorder->appends(['hj_start_time' => $hj_start_time, 'hj_user_tupe' => $hj_user_type,'hj_phone' => $hj_phone]) }}</div>
                </div>
            </div>
            </div>
        </div>
