    ...
    <ul class="navList" id="navList">
        ...
        <li class="navListLi">
            ...
            <ul class="navListBottom">
				...
				<li >
                    <a href="{{ url('admin/car/index') }}"><p class="navBottomTitle">登记车辆</p></a>
                </li>
            </ul>
        </li>
        ...
        <li class="navListLi">
            ...
            <div class="navTitleDiv">
                ...
                <p class="navTitle">商城管理</p>
            </div>
			<ul class="navListBottom">
                <li >
                    <a href="{{ url('admin/goods/index') }}"><p class="navBottomTitle">商品管理</p></a>
                </li>
				<li >
                    <a href="{{ url('admin/cate/index') }}"><p class="navBottomTitle">商品分类</p></a>
                </li>
            </ul>
        </li>
        ...
        <li class="navListLi">
            ...
            <div class="navTitleDiv">
                <img class="navImg" src="{{ url('admin/images/goods.png') }}" alt="">
                <p class="navTitle">运营管理</p>
            </div>
			<ul class="navListBottom">
                <li >
                    <a href="{{ url('admin/company/index') }}"><p class="navBottomTitle">企业管理</p></a>
                </li>
				<li >
                    <a href="{{ url('admin/store/index') }}"><p class="navBottomTitle">店铺管理</p></a>
                </li>
				<li >
                    <a href="{{ url('admin/project/index') }}"><p class="navBottomTitle">服务项目</p></a>
                </li>
            </ul>
        </li>
        ...
        <li class="navListLi">
            ...
            <ul class="navListBottom">
                <li >
                    <a href="{{ url('admin/card/index') }}">
						<p class="navBottomTitle">卡券列表</p>
					</a>
                </li>
				<li >
                    <a href="{{ url('admin/card/recode') }}">
						<p class="navBottomTitle">发卡记录</p>					
					</a>
                </li>
				<li >
                    <a href="{{ url('admin/card/recode') }}">
						<p class="navBottomTitle">余卡情况</p>					
					</a>
                </li>
                <li >
                    <a href="{{ url('admin/card/recode') }}">
						<p class="navBottomTitle">核销记录</p>					
					</a>
                </li>
            </ul>
        </li>
        ...
        <li class="navListLi">
            ...
            <ul class="navListBottom">
                ...
                <li >
                    <a href="{{ url('admin/order/day?hj_start_time=0') }}"><p class="navBottomTitle">员工洗车</p></a>
                </li>
                <li >
                    <a href="{{ url('admin/order/goodsorder?hj_start_time=0') }}"><p class="navBottomTitle">员工优品</p></a>
                </li>
            </ul>
        </li>
        <!--促销管理-->
        ...
        <li class="navListLi">
            ...
            <div class="navTitleDiv">
                <img class="navImg" src="{{ url('admin/images/distribution.png') }}" alt="">
                <p class="navTitle">系统管理</p>
            </div>
			<ul class="navListBottom">
                <li >
                    <a href="{{ url('admin/user/index') }}">
						<p class="navBottomTitle">管理账号</p>
					</a>
                </li>
                <li >
                    <a href="{{ url('admin/permission/index') }}">
						<p class="navBottomTitle">管理权限</p>
					</a>
                </li>
                <li >
                    <a href="{{ url('admin/operation/index') }}">
						<p class="navBottomTitle">操作记录</p>
					</a>
                </li>
				<li >
                    <a href="{{ url('admin/config/index') }}">
						<p class="navBottomTitle">网站配置</p>
					</a>
                </li>
				<li >
                    <a href="{{ url('admin/banner/index') }}"><p class="navBottomTitle">轮播图管理</p></a>
                </li>
            </ul>
        </li>
        </li>
