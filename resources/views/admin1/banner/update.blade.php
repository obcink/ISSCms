...
@section('content')
    ...
    <section id="hiddenDiv26">
        ...
        <ul class="nav nav-tabs">
            <li><a href="{{ url('admin/banner/index') }}">返回上一页</a></li>
            <li class="active"><a href=""  data-toggle="tab">修改banner图</a></li>
        ...
        <div class="" id="plbigct">
            <div class="allShow2">
                <form action="{{ url('admin/goods/update/'.$data['id']) }}" method="post">
                    {{ csrf_field() }}
                    <ul class="information">
                        ...
                        <li>
                            <ul class="informationList">
                                <li>
                                    ...
                                    <input class="goodsInput" id="goodsInput1" value="{{ $data['hj_name'] }}" name="hj_name" type="text" placeholder="请输入产品名称">
                                </li>
                                <!--选择分类-->
                                <li>
                                    <span class="tigDiv"></span>
                            ...
                            <div class="attribute">
                                <ul class="attributeList" id="attributeList">
                                    ...
                                    <li>
                                        ...
                                        <input type="text" id="goodsInput4" name="hj_new_price" value="{{ $data['hj_new_price'] }}" class="attributeInput attributeInput1" value="" placeholder="0">
                                        <p class="attributeIcon">元</p>
                                    </li>
                                    <li>
                                        <span class="tigDiv"></span>
                                        <p class="attributeName attributeInput2">商品库存：</p>
                                        <input type="text" id="goodsInput8" name="hj_stock" value="{{ $data['hj_stock'] }}" placeholder="0" class="attributeInput" value="">
                        ...
                        <!--所属门店-->
                        <li>
                            <input type="checkbox" @if(in_array(1,$group)) checked @endif name="hj_group[]" value="1">&nbsp;门店商品&nbsp;&nbsp;
                            <input type="checkbox" @if(in_array(2,$group)) checked @endif name="hj_group[]" value="2">&nbsp;卡券兑换商品&nbsp;&nbsp;
                            <input type="checkbox" @if(in_array(3,$group)) checked @endif name="hj_group[]" value="3">&nbsp;积分兑换商品&nbsp;&nbsp;<br>
                        </li>
                        <!--选择分类-->
                        <li>
                            <span class="tigDiv"></span>
                            ...
                            <select name="hj_coil" class="link" id="washCard">
                                <option @if($data['hj_coil'] == 1) selected @endif value="1">普通快洗卡</option>
                                <option @if($data['hj_coil'] == 2) selected @endif value="2">高级快洗卡</option>
                                <option @if($data['hj_coil'] == 3) selected @endif value="3">超级快洗卡</option>
                            </select>
                        </li>
                    </ul>
                    <!--保存提交按钮-->
