                ...
                <div class="tab-pane fade in active" id="cadrc1">
                    <div class="allShow2">
                        <div class="allShow2">
                            ...
                            <div>{{ $data->appends([ 'hj_name' => $hj_name,'hj_phone' => $hj_phone,  'hj_b_name' => $hj_b_name,'hj_b_phone' => $hj_b_phone, 'hj_car_number' => $hj_car_number, 'icoterie_type' => $icoterie_type, 'icoterie_stime' => $stime, 'etime' => $etime]) }}</div>
