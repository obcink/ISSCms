...
<html lang="zxx">
<head>
<title>Sign In:: Icoterie Smart System</title>
<!-- custom-theme -->
			...
			<div class="registration admin_agile">			
				<div class="signin-form profile admin">
					...
					<div class="login-form">
						<form action="{{ url('admincp/login') }}" method="post">{{ csrf_field() }}
							<input type="text" name="user_name" placeholder="User name" required="" value="">
							<input type="password" name="password" placeholder="Pass word" required="" value="">
							<div class="tp">
					...
					<h6><a href="{{ url('home/index') }}">Back To Home</a><h6>
