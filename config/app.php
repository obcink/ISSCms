...
return [
    ...
    */
    ...
    'providers' => [
		...
		//Overtrue\LaravelWeChat\ServiceProvider::class,//新增微信
		//Intervention\Image\ImageServiceProvider::class,//新增图片处理
    ...
    */
    ...
    'aliases' => [
		...
		//'EasyWeChat' => Overtrue\LaravelWeChat\Facade::class,//新增微信
        //'Image' => Intervention\Image\Facades\Image::class,//新增图片处理
    ],
